...
class BaseAPIException(PlexiChatException):
    ...
    def __init__(
        self,
        code: str = PlexiChatErrorCode.SYSTEM_INTERNAL_ERROR.value,
...
class AuthenticationError(BaseAPIException):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None) -> None:
        super().__init__(
            PlexiChatErrorCode.AUTH_INVALID_CREDENTIALS.value, details=details
        )
...
class ValidationError(BaseAPIException):
    ...
    def __init__(
        ...
        super().__init__(
            PlexiChatErrorCode.VALIDATION_ERROR.value, details=base_details
        )
...
class DatabaseError(BaseAPIException):
    ...
    def __init__(self, details: Optional[Dict[str, Any]] = None) -> None:
        super().__init__(
            PlexiChatErrorCode.DATABASE_CONNECTION_FAILED.value, details=details
        )
