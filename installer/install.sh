#!/bin/bash
# NetLink Installer for Linux/macOS
...
print_header() {
    echo "============================================================"
    print_color $CYAN "🚀 NetLink Installer"
...
download_installer() {
    print_color $BLUE "⬇️  Downloading NetLink installer..."
    ...
    # Download installer
    if curl -s -L "https://raw.githubusercontent.com/linux-of-user/netlink/main/installer/install.py" -o "$INSTALLER_PATH"; then
...
main() {
    ...
    print_color $BLUE "🚀 Starting NetLink installation..."
    echo
