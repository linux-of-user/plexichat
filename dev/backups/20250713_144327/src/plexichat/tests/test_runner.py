...
class PlexiChatTestRunner:
    ...
    async def run_all_tests(self) -> Dict[str, Any]:
        """Run all test suites."""
        logger.info(" PlexiChat Test Suite")
        logger.info("=" * 50)
        ...
        for test_class in self.test_classes:
            ...
            try:
                ...
                logger.info(f" Test suite {test_name} failed: {e}")
    ...
    def print_final_summary(self, summary: Dict[str, Any]):
        ...
        if failed_tests:
            ...
            for test in failed_tests:
                logger.info(f"   {test.test_name} ({test.category}): {test.error_message}")
    ...
    def run_specific_category(self, category: str) -> Dict[str, Any]:
        ...
        if category not in category_map:
            logger.info(f" Unknown test category: {category}")
