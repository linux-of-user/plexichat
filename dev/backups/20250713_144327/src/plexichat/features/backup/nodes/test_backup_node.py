...
import httpx
from = httpx backup_node.backup_node_client import BackupNodeClient
...
class BackupNodeTester:
    ...
    async def run_all_tests(self):
        """Run all tests."""
        logger.info(" PlexiChat Backup Node Test Suite")
        logger.info("=" * 50)
...
async def main():
    ...
    logger.info(f" Testing backup node at {args.address}:{args.port}")
