...
class LinkSafetyScanner:
    ...
    def __init__(self, data_dir: Path):
        ...
        self.suspicious_patterns = [
            ...
            re.compile(
                r"(login|secure|account|verify|update|confirm).*\.(tk|ml|ga|cf)"
            ),  # Phishing patterns
            re.compile(r"[0-9]+[a-z]+[0-9]+\."),  # Mixed numbers and letters
            re.compile(
                r"(paypal|amazon|google|microsoft|apple|facebook).*[0-9]+\."
            ),  # Brand impersonation
        ]
    ...
    def _analyze_url_patterns(self, url: str, parsed_url) -> Dict[str, Any]:
        ...
        return {"risk_level": min(1.0, risk_level), "details": details}
    ...
    async def _load_domain_lists(self):
        ...
        try:
            ...
            logger.info(
                f"Loaded {len(self.malicious_domains)} malicious domains, "
    ...
    def _create_error_result(
        self, url: str, error_message: str, start_time: datetime
    ) -> ScanResult:
    ...
    async def add_malicious_domain(
        self,
        domain: str,
    ...
    def get_scan_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "detection_rate": (
                (
                    self.scan_stats["malicious_found"]
                    + self.scan_stats["suspicious_found"]
                )
