"""
NetLink Multi-Tier Cache API Endpoints
...
from netlink.core.performance.multi_tier_cache_manager import get_cache_manager, MessagePriority
from netlink.core.auth.dependencies import require_auth, require_admin
...
async def clear_cache(
    ...
    try:
        ...
        if request.tier:
            ...
            from netlink.core.performance.multi_tier_cache_manager import CacheTier
