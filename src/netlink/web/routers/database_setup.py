...
from netlink.core.database_setup_wizard import database_wizard, DatabaseType, SetupStep
from netlink.core.external_database import external_db_manager, DatabaseProvider, DatabaseEngine, ExternalDatabaseConfig
from netlink.utils.auth import verify_admin_token
...
async def test_external_database(
    ...
    try:
        ...
        from netlink.core.external_database import ExternalDatabaseManager
