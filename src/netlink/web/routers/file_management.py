...
from netlink.auth.dependencies import get_current_admin_user
...
class FileManager:
    ...
    def __init__(self):
        ...
        self.config_paths = [
            "config",
            "configs", 
            "src/netlink/app/config",
            "src/netlink/app/modules",
            "src/netlink/app/security",
            "src/netlink/app/backup",
            "src/netlink/ai/config",
            "templates",
