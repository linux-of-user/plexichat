...
middleware_modules = [
    'security_middleware', 'comprehensive_security_middleware',
    'government_security', 'message_security_middleware'
]
    ...
    try:
        ...
        for attr_name in dir(module):
            ...
            if (isinstance(attr, type) and 
                ...
                attr.__module__.startswith(__name__)):
