#!/usr/bin/env python3
"""
NetLink Standalone Backup Node

A simple, standalone backup node that can be run independently of the main NetLink application.
...
try:
    from netlink.app.backup.backup_node_system import BackupNodeSystem, BackupNodeConfig, NodeMode
except ImportError:
    print("❌ Error: Could not import NetLink backup system.")
...
def create_default_config(config_path: str, args):
    ...
    config = {
        ...
        "node_name": "NetLink Standalone Backup Node",
...
def print_banner():
    ...
    print("=" * 60)
    print("🚀 NetLink Standalone Backup Node v3.0.0")
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="NetLink Standalone Backup Node",
