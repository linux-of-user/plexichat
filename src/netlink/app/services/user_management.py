"""
Comprehensive user management service for NetLink.
    ...
    async def create_bot_account(
        ...
        try:
            ...
            bot_user = EnhancedUser(
                username=username,
                email=f"{username}@bot.netlink.local",
