...
from netlink.app.models.files import FileRecord, FilePermission, FileShare, FilePermissionType, FileAccessLevel
from netlink.app.models.user import User
from netlink.app.services.file_permissions import FilePermissionService
...
async def get_file_access_logs(
    ...
    from netlink.app.models.files import FileAccessLog
