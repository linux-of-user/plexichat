"""
Security & Anti-Virus API endpoints for NetLink.
...
from netlink.app.services.security_service import security_service, ThreatType, ThreatLevel
...
async def get_decentralized_security_status():
    ...
    try:
        from netlink.app.security.decentralized_security import get_decentralized_security
...
async def report_security_event(request: dict):
    ...
    try:
        from netlink.app.security.decentralized_security import get_decentralized_security, SecurityLevel
