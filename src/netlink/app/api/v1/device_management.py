...
from netlink.app.services.intelligent_shard_distribution import IntelligentShardDistribution
...
async def get_network_status(
    ...
    try:
        from netlink.app.services.backup_status_monitor import get_backup_status_monitor
