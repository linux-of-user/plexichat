...
from netlink.core.security.government_auth import get_current_admin
...
DOCS_STORAGE = {
    "installation": {
        ...
        "content": """# NetLink Installation Guide
...
Edit the `config/netlink.yaml` file to customize your installation.
...
### CLI Administration
```bash
python -m netlink.cli.admin_cli --help
```
""",
        "category": "setup",
...
NetLink implements government-level security measures designed for organizations requiring the highest levels of protection.
...
python -m netlink.cli.admin_cli change-password

# Enable 2FA
python -m netlink.cli.admin_cli setup-2fa
```
...
5. **Update System**: Keep NetLink and dependencies updated
...
NetLink includes features designed for regulatory compliance:
