...
class NetLinkApp {
    ...
    showNotification(message, type = 'info', duration = 5000) {
        ...
        notification.innerHTML = `
            <div class="notification-content">
                ...
                <span>${message}</span>
                <button class="notification-close" onclick="netlink.closeNotification('${id}')">
    ...
    getSessionId() {
        return localStorage.getItem('netlink_session') || 
               document.cookie.split('; ')
                   .find(row => row.startsWith('netlink_session='))
                   ?.split('=')[1];
    }
...
// Initialize the application
const netlink = new NetLinkApp();

// Export for global access
window.netlink = netlink;
