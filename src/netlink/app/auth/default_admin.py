...
logger = logging.getLogger("netlink.auth.default_admin")
...
╔══════════════════════════════════════════════════════════════════════════════╗
║                          NETLINK DEFAULT ADMIN CREDENTIALS                  ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
...
CLI Commands to manage admin users:
  ...
  python -m netlink.cli.admin_manager create --username newadmin --role admin
