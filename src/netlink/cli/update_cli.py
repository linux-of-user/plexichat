...
class UpdateCLI:
    ...
    def create_parser(self) -> argparse.ArgumentParser:
        ...
        parser = argparse.ArgumentParser(
            description="NetLink Update System CLI",
...
Examples:
  ...
  netlink update rollback
    ...
    async def handle_check(self, args):
        ...
        try:
            ...
            if update_info['updates_available']:
                ...
                print(f"\n💡 Run 'netlink update upgrade' to update")
            else:
                print("✅ NetLink is up to date!")
    ...
    async def handle_version(self, args):
        ...
        print(f"📦 NetLink Version: {current_version}")
    ...
    async def handle_upgrade(self, args):
        ...
        try:
            ...
            if result.success:
                ...
                if result.rollback_available:
                    print(f"🔄 Rollback available - run: netlink update rollback --update-id {result.update_id}")
