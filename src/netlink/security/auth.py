"""
NetLink Unified Authentication System

Consolidates authentication functionality from:
- src/netlink/core/auth/ (unified auth managers)
- src/netlink/app/auth/ (advanced auth features)
...
class AuthManager:
    ...
    - src/netlink/core/auth/auth_manager.py
    - src/netlink/app/auth/ modules
    """
