...
class ConfigurationManager:
    ...
    def _get_env_overrides(self) -> Dict[str, Any]:
        ...
        env_mapping = {
            'NETLINK_LOG_DIRECTORY': 'directory',
            'NETLINK_LOG_LEVEL': 'level',
            'NETLINK_LOG_BUFFER_SIZE': ('buffer_size', int),
            'NETLINK_LOG_CONSOLE_ENABLED': ('console_enabled', self._parse_bool),
            'NETLINK_LOG_CONSOLE_LEVEL': 'console_level',
            'NETLINK_LOG_CONSOLE_COLORS': ('console_colors', self._parse_bool),
            'NETLINK_LOG_CONSOLE_FORMAT': 'console_format',
            'NETLINK_LOG_FILE_ENABLED': ('file_enabled', self._parse_bool),
            'NETLINK_LOG_FILE_LEVEL': 'file_level',
            'NETLINK_LOG_FILE_FORMAT': 'file_format',
            'NETLINK_LOG_MAX_FILE_SIZE': 'max_file_size',
            'NETLINK_LOG_BACKUP_COUNT': ('backup_count', int),
            'NETLINK_LOG_STRUCTURED_ENABLED': ('structured_enabled', self._parse_bool),
            'NETLINK_LOG_INCLUDE_CONTEXT': ('include_context', self._parse_bool),
            'NETLINK_LOG_DATE_FORMAT': 'date_format',
            'NETLINK_LOG_PERFORMANCE_ENABLED': ('performance_enabled', self._parse_bool),
            'NETLINK_LOG_PERFORMANCE_INTERVAL': ('performance_interval', int),
            'NETLINK_LOG_SECURITY_ENABLED': ('security_enabled', self._parse_bool),
            'NETLINK_LOG_AUDIT_ENABLED': ('audit_enabled', self._parse_bool),
            'NETLINK_LOG_STREAMING_ENABLED': ('streaming_enabled', self._parse_bool),
            'NETLINK_LOG_ALERTS_ENABLED': ('alerts_enabled', self._parse_bool),
            'NETLINK_LOG_ALERT_EMAIL': 'alert_email',
            'NETLINK_LOG_ALERT_WEBHOOK': 'alert_webhook',
            'NETLINK_LOG_ALERT_SLACK': 'alert_slack',
            'NETLINK_LOG_COMPRESSION_ENABLED': ('compression_enabled', self._parse_bool),
            'NETLINK_LOG_ARCHIVE_ENABLED': ('archive_enabled', self._parse_bool),
            'NETLINK_LOG_ARCHIVE_AFTER_DAYS': ('archive_after_days', int),
            'NETLINK_LOG_SILENCE_THIRD_PARTY': ('silence_third_party', self._parse_bool),
            'NETLINK_LOG_THIRD_PARTY_LEVEL': 'third_party_level',
            'NETLINK_LOG_ASYNC_LOGGING': ('async_logging', self._parse_bool),
            'NETLINK_LOG_QUEUE_SIZE': ('queue_size', int),
            'NETLINK_LOG_FLUSH_INTERVAL': ('flush_interval', float),
        }
