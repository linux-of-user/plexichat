...
to publish and manage their plugins in the NetLink marketplace.
"""
...
class PluginOAuthProvider:
    ...
    async def register_client(self, client_name: str, redirect_uris: List[str],
        ...
        try:
            ...
            client_id = f"netlink_plugin_{secrets.token_urlsafe(16)}"
    ...
    async def _create_default_client(self):
        ...
        try:
            await self.register_client(
                client_name="NetLink Plugin Developer",
    ...
    async def _load_oauth_data(self):
        ...
        try:
            ...
            if clients_file.exists():
                async with aiofiles.open(clients_file, 'r') as f:
...
_oauth_provider: Optional[PluginOAuthProvider] = None
