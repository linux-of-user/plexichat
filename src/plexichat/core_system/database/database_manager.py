"""
PlexiChat Unified Database Manager

Consolidated database management system combining features from:
- database_manager.py (core functionality)
- enhanced_database_manager.py (advanced features)
- enhanced_abstraction.py (multi-database support)
