...
class AdvancedORM:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        """Get ORM statistics."""
        cache_hit_rate = 0.0
        total_cache_operations = self.query_metrics.cache_hits + self.query_metrics.cache_misses
        ...
        return {
            "query_metrics": {
                ...
                "fastest_query_time": self.query_metrics.fastest_query_time if self.query_metrics.fastest_query_time != float('inf') else 0.0,
