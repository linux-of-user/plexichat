...
def crash_handler(severity: ErrorSeverity = ErrorSeverity.CRITICAL,
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            for attempt in range(max_attempts):
                try:
                    ...
                    logger.warning(f"Retry {attempt + 1}/{max_attempts} for {func.__name__} after {current_delay}s: {e}")
