# NetLink Installer for Windows PowerShell
# Downloads and installs NetLink from GitHub
...
function Show-Header {
    ...
    Write-ColorOutput "🚀 NetLink Installer" "Cyan"
...
function Show-Help {
    Show-Header
    Write-Host "NetLink Installer for Windows"
    Write-Host
    Write-Host "Usage:"
    Write-Host "  .\install.ps1                    # Interactive installation"
    Write-Host "  .\install.ps1 -InstallPath C:\NetLink  # Install to specific path"
    Write-Host "  .\install.ps1 -Force             # Force installation"
    Write-Host "  .\install.ps1 -Help              # Show this help"
    Write-Host
    Write-Host "Examples:"
    Write-Host "  .\install.ps1"
    Write-Host "  .\install.ps1 -InstallPath C:\Tools\NetLink"
    Write-Host
}
...
function Get-NetLinkInstaller {
    Write-ColorOutput "⬇️  Downloading NetLink installer..." "Blue"
    
    # Create temporary directory
    $tempDir = [System.IO.Path]::GetTempPath()
    $installerPath = Join-Path $tempDir "netlink_install.py"
    
    try {
        # Download installer
        $url = "https://raw.githubusercontent.com/linux-of-user/netlink/main/installer/install.py"
...
function Start-Installation {
    ...
    Write-ColorOutput "🚀 Starting NetLink installation..." "Blue"
    Write-Host
...
function Main {
    ...
    # Download installer
    $installerPath = Get-NetLinkInstaller
