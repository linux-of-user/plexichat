    ...
    def __init__(self):
        ...
        self.versions = {
            ...
            "current": {
                ...
                "deprecated": False,
                "sunset_date": None,
                "features": ["core", "messaging", "files", "users", "auth", "collaboration", "updates", "analytics"]
            },
            "beta": {
                "version": "b.1.2-1",
                "path": "/api/beta",
                ...
                "deprecated": False,
                "sunset_date": None,
                "features": ["core", "messaging", "files", "users", "auth", "collaboration", "updates", "analytics", "ai", "quantum"]
            }
        }
    ...
    def create_version_router(self) -> APIRouter:
        ...
        async def check_feature_compatibility(feature: str):
            ...
            return {
                ...
                "latest_version": max(self.feature_compatibility[feature], 
...
class APIVersionMiddleware:
    ...
    async def __call__(self, request: Request, call_next):
        ...
        if hasattr(response, 'headers'):
            ...
            response.headers["X-API-Version-Info"] = json.dumps(request.state.version_info)
            ...
            if unavailable_features:
                return JSONResponse(
                    ...
                    content={
                        ...
                        "available_in": {
                            feature: version_manager.feature_compatibility.get(feature, [])
