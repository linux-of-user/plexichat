...
class MockAntivirusManager:
    ...
    _initialized = True
    config = {
        "enabled": True, "real_time_scanning": True, "scan_workers": 4,
        "max_file_size": 100 * 1024 * 1024, "hash_scanning": True,
        "behavioral_analysis": True, "filename_analysis": True,
        "threat_intelligence": True, "link_scanning": True, "plugin_scanning": True
    }
    async def initialize(self): pass
    async def get_scan_statistics(self): return {}
    async def scan_file(self, *args, **kwargs): return []
    async def scan_plugin(self, *args, **kwargs): return []
    async def scan_url(self, *args, **kwargs): return type("obj", (), {"threat_level": "CLEAN"})()
    async def get_quarantine_list(self): return []
    async def restore_from_quarantine(self, *args, **kwargs): return True
    async def delete_quarantined_file(self, *args, **kwargs): return True
    async def update_threat_database(self): return True
