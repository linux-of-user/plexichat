...
class MockAIAbstractionLayer:
    ...
    async def configure_provider(self, *args, **kwargs):
        return True

    async def refresh_provider(self, *args, **kwargs):
        pass

    async def discover_ollama_models(self):
        return []

    async def pull_ollama_model(self, model_id):
        return True

    async def delete_ollama_model(self, model_id):
        return True
    ...
    async def health_check(self):
        return {"overall_status": "HEALTHY", "models": {}, "providers": {}}

    async def process_request(self, request):
        return type("obj", (), {"success": True, "content": "Mock response"})()
