...
class MockUnifiedPluginManager:
    class MockIsolationManager:
        ...
        def grant_plugin_module_permission(self, *args):
            pass

        def revoke_plugin_module_permission(self, *args):
            pass
...
def grant_plugin_module(plugin_name, module_name):
    ...
    unified_plugin_manager.isolation_manager.grant_plugin_module_permission(
...
def revoke_plugin_module(plugin_name, module_name):
    ...
    unified_plugin_manager.isolation_manager.revoke_plugin_module_permission(
        plugin_name, module_name
    )
