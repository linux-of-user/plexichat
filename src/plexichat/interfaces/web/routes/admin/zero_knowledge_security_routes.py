...
class ZeroKnowledgeSecurityService:
    ...
    async def enable_zero_knowledge(self, *a, **k):
        return True

    async def disable_zero_knowledge(self, *a, **k):
        return True
    ...
    if getattr(request, "method", "GET") == "POST":
        try:
            ...
            if new_config:
                ...
                flash(
                    "Zero-knowledge security configuration updated successfully",
                    "success",
                )
            else:
