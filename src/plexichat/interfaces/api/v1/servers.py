...
async def create_server(
    ...
    try:
        ...
        # saved_server = await server_repo.create(server)
...
async def list_user_servers(
    ...
    try:
        ...
        # server_repo = get_server_repository()
        # member_repo = get_server_member_repository()
        # user_servers = await server_repo.get_user_servers(current_user.id)
...
async def get_server(
    ...
    try:
        ...
        # member_repo = get_server_member_repository()
        # member = await member_repo.get_member(server_id, current_user.id)
        # if not member:
