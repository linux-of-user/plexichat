...
@router.get("/admin/stats", dependencies=[Depends(from plexichat.infrastructure.utils.auth import from plexichat.infrastructure.utils.auth import require_admin_auth)])
