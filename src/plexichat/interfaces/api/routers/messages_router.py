...
if router:
    ...
    async def get_messages()
        ...
        try:
            ...
            # Cache result
            if result:
                await cache_set(cache_key, result, ttl=300)  # Cache for 5 minutes
    ...
    async def get_message(
        ...
        try:
            ...
            # Check cache first
            cache_key = CacheKeyBuilder.message_key(message_id)
            ...
            # Cache result
            await cache_set(cache_key, result, ttl=600)  # Cache for 10 minutes
