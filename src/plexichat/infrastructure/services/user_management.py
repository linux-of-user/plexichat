...
class UserManagementService:
        ...
        try:
            ...
            if hasattr(self.auth_manager, "update_user_profile"):
                try:
                    ...
                    awaitable = self.auth_manager.update_user_profile(
                        username,
                        {
                            "email": email,
                    ...
                    logger.debug(
                        f"Profile update after registration failed for {username}: {e}"
                    )
    ...
    async def authenticate_user(
        ...
        try:
            ...
            try:
                logger.security(
                    f"Authentication attempt for user {username}", user_id=username
                )
            except Exception:
    ...
    async def create_bot_account(
        ...
        if hasattr(self.auth_manager, "create_bot_account"):
            ...
            logger.warning(
                "create_bot_account called but UnifiedAuthManager does not support bot accounts"
            )
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Bot accounts are not supported by the UnifiedAuthManager",
            )

    async def update_bot_permissions(
        self, bot_id: Any, owner_id: Any, permissions: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        if hasattr(self.auth_manager, "update_bot_permissions"):
            try:
                result = self.auth_manager.update_bot_permissions(
                    bot_id=bot_id, owner_id=owner_id, permissions=permissions
                )
                if hasattr(result, "__await__"):
                    result = await result
                return result
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Bot permission management is not supported",
            )
    ...
    async def get_user_bots(self, owner_id: Any) -> list[dict[str, Any]]:
        ...
        raise HTTPException(
            status_code=status.HTTP_501_NOT_IMPLEMENTED,
            detail="Bot listing not supported",
        )
    ...
    async def delete_bot_account(self, bot_id: Any, owner_id: Any) -> bool:
        ...
        if hasattr(self.auth_manager, "delete_bot_account"):
            result = self.auth_manager.delete_bot_account(
        ...
        raise HTTPException(
            status_code=status.HTTP_501_NOT_IMPLEMENTED,
            detail="Bot deletion not supported",
        )

    async def update_user_profile(
        self, user_id: Any, updates: dict[str, Any]
    ) -> dict[str, Any]:
        """Update user profile information by delegating to UnifiedAuthManager if supported."""
        if hasattr(self.auth_manager, "update_user_profile"):
            result = self.auth_manager.update_user_profile(
            ...
            logger.warning(
                "update_user_profile called but UnifiedAuthManager does not provide profile management"
            )
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Profile updates not supported",
            )

    async def update_user_email(
        self, user_id: Any, new_email: str, password: str
    ) -> bool:
        """Update user email with password verification via UnifiedAuthManager."""
        if hasattr(self.auth_manager, "update_user_email"):
            result = self.auth_manager.update_user_email(
                user_id=user_id, new_email=new_email, password=password
            )
            if hasattr(result, "__await__"):
                result = await result
            return bool(result)
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Email updates not supported",
            )

    async def change_password(
        self, user_id: Any, current_password: str, new_password: str
    ) -> bool:
        ...
        if hasattr(self.auth_manager, "change_password"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Password changes not supported",
            )

    async def upload_profile_picture(
        self, user_id: Any, file_data: bytes, filename: str, mime_type: str
    ) -> str | None:
        ...
        if hasattr(self.auth_manager, "upload_profile_picture"):
            result = self.auth_manager.upload_profile_picture(
                user_id, file_data, filename, mime_type
            )
            if hasattr(result, "__await__"):
                result = await result
            return result
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Profile picture uploads not supported",
            )

    async def delete_user_account(
        self, user_id: Any, password: str, hard_delete: bool = False
    ) -> bool:
        ...
        if hasattr(self.auth_manager, "delete_user_account"):
            result = self.auth_manager.delete_user_account(
                user_id=user_id, password=password, hard_delete=hard_delete
            )
            if hasattr(result, "__await__"):
                result = await result
            return bool(result)
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Account deletion not supported",
            )

    async def get_user_profile(
        self, user_id: Any, include_private: bool = False
    ) -> dict[str, Any] | None:
        ...
        if hasattr(self.auth_manager, "get_user_profile"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Profile retrieval not supported",
            )
    ...
    async def update_user_permissions(
        self, user_id: Any, permissions: set[str]
    ) -> bool:
    ...
    async def send_friend_request(
        ...
        if hasattr(self.auth_manager, "send_friend_request"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Friend requests not supported",
            )

    async def respond_to_friend_request(
        self, friendship_id: Any, user_id: Any, accept: bool
    ) -> bool:
        ...
        if hasattr(self.auth_manager, "respond_to_friend_request"):
            result = self.auth_manager.respond_to_friend_request(
                friendship_id, user_id, accept
            )
            if hasattr(result, "__await__"):
                result = await result
            return bool(result)
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Friend responses not supported",
            )

    async def remove_friend(self, user_id: Any, friend_id: Any) -> bool:
        ...
        if hasattr(self.auth_manager, "remove_friend"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Removing friends not supported",
            )

    async def block_user(self, blocker_id: Any, blocked_id: Any) -> bool:
        ...
        if hasattr(self.auth_manager, "block_user"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Blocking users not supported",
            )

    async def get_friends_list(self, user_id: Any) -> list[dict[str, Any]]:
        ...
        if hasattr(self.auth_manager, "get_friends_list"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Friends list not supported",
            )

    async def get_pending_friend_requests(
        self, user_id: Any, sent: bool = False
    ) -> list[dict[str, Any]]:
        ...
        if hasattr(self.auth_manager, "get_pending_friend_requests"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="Pending friend requests not supported",
            )

    async def search_users(
        self, query: str, limit: int = 20, exclude_user_id: Any | None = None
    ) -> list[dict[str, Any]]:
        ...
        if hasattr(self.auth_manager, "search_users"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="User search not supported",
            )

    async def get_user_statistics(self, user_id: Any) -> dict[str, Any] | None:
        ...
        if hasattr(self.auth_manager, "get_user_statistics"):
            ...
            raise HTTPException(
                status_code=status.HTTP_501_NOT_IMPLEMENTED,
                detail="User statistics not supported",
            )

    async def update_user_activity(self, user_id: Any) -> bool:
        ...
        if hasattr(self.auth_manager, "update_user_activity"):
            ...
            logger.debug(
                f"update_user_activity called for {user_id} but UnifiedAuthManager does not support it"
            )
            return False
