                ...
                default_content = [
                    {
                        ...
                        "content": "Welcome to PlexiChat's AI-powered features. This system provides intelligent summarization, content suggestions, sentiment analysis, semantic search, and automated content moderation.",
                        "metadata": {"category": "documentation", "type": "welcome"}
                    },
                    {
                        "content_id": "features_overview",
                        "content": "PlexiChat AI features include: text summarization for creating brief summaries, content suggestions for writing assistance, sentiment analysis for understanding emotions, semantic search for finding relevant content, and automated moderation for content safety.",
