"""
Comprehensive file permissions service for NetLink.
...
from netlink.app.models.files import (
...
class FilePermissionService:
    ...
    async def grant_permission(
        ...
        try:
            ...
            self.session.commit()
            logger.info(f"Granted permissions to user {target_user_id} for file {file_id}")
            return True
