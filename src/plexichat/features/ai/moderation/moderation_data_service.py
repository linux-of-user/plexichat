...
class ModerationDataService:
    ...
    async def get_moderation_results(self, filters: dict[str, Any] | None = None) -> list[dict[str, Any]]:
        if self.db_manager:
    ...
    async def get_latest_moderation_result_by_hash(self, content_hash: str) -> Any | None:
