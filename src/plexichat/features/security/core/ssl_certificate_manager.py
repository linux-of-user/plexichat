"""
PlexiChat SSL Certificate Manager
...
class SSLCertificateManager:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        # Configuration
        self.cert_directory = Path(self.config.get("cert_directory", "/etc/ssl/plexichat"))
    ...
    async def generate_self_signed_certificate(self, domain: str, key_size: int = 2048, validity_days: int = 365) -> Certificate:
        ...
        try:
            ...
            subject = issuer = x509.Name([
                ...
                x509.NameAttribute(NameOID.ORGANIZATION_NAME, "PlexiChat Security"),
