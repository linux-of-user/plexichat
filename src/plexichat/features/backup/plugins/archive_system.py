        ...
        async with aiosqlite.connect(self.archive_db_path) as db:
            ...
            """,
                (
                    ...
                    archive.total_versions,
                    archive.retention_policy,
                    archive.compression_enabled,
                    archive.encryption_enabled,
                    json.dumps(list(archive.tags)),
        ...
        async with aiosqlite.connect(self.archive_db_path) as db:
            ...
            """,
                (
                    ...
                    version.archive_type.value,
                    version.created_at,
                    version.expires_at,
                    version.size_bytes,
                    version.compressed_size_bytes,
                    json.dumps(version.shard_ids),
