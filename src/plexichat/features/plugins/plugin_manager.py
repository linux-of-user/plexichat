"""
Modular Plugin System for PlexiChat.
...
class PluginInterface(ABC):
    """Base interface for all PlexiChat plugins."""
...
class PluginManager:
    ...
    def _create_example_plugin(self):
        ...
        with open(init_file, 'w') as f:
            f.write('"""Example PlexiChat Plugin"""\n')
        
        # Create plugin.py
        plugin_file = example_dir / "plugin.py"
        with open(plugin_file, 'w') as f:
            f.write('''"""
Example PlexiChat Plugin
Demonstrates the plugin system capabilities.
"""

from plexichat.app.plugins.plugin_manager import PluginInterface, PluginMetadata
...
class ExamplePlugin(PluginInterface):
    ...
    def __init__(self):
        ...
        self.metadata = PluginMetadata(
            name="Example Plugin",
            version="1.0.0",
            description="Demonstrates PlexiChat plugin capabilities",
            author="PlexiChat Team",
            email="plugins@plexichat.example.com",
            dependencies=[]
        )
