"""
NetLink Message Security Middleware
...
from netlink.services.security_service import SecurityService, ThreatType, ThreatLevel
import logging import logger

# Import antivirus components
try:
    from netlink.antivirus.core.message_scanner import MessageAntivirusScanner, MessageThreatLevel
