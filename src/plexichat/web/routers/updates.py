...
from netlink.web.routers.auth import get_current_admin_user
...
async def install_update(
    ...
    try:
        ...
        package_files = list(temp_path.glob(f"netlink_update_{update_info.latest_version}.*"))
        ...
        return {
            ...
            "warning": "NetLink will need to be restarted after installation"
        }
