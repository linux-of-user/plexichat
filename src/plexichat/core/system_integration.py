...
class SystemIntegrator:
    ...
    def get_all_python_modules(self) -> List[str]:
        ...
        core_modules = [
            ...
            "plexichat.core.database.nosql_clients",
            "plexichat.core.database.analytics_clients",
            "plexichat.core.database.lakehouse",
            "plexichat.core.database.sql_clients",
            "plexichat.core.database.database_factory",
            "plexichat.core.database.partitioning_strategy",
