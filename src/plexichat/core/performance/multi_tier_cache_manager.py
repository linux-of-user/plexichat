"""
NetLink Multi-Tier Caching System
    ...
    if _cache_manager is None:
        if config is None:
            ...
            config = {
                ...
                "cdn": {
                    "base_url": "https://cdn.netlink.local",
                    "upload_url": "https://api.cdn.netlink.local/upload",
                    "invalidate_url": "https://api.cdn.netlink.local/invalidate",
                    "timeout": 30,
                    "max_connections": 100
                }
            }
