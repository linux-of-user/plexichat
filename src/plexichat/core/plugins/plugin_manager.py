        ...
        try:
            ...
            if enhanced_plugin_security:
                try:
                    ...
                    if security_level:
                        profile = enhanced_plugin_security.create_security_profile(
                            plugin_name, security_level
                        )
                        secure_import = (
                            enhanced_plugin_security.create_secure_import_hook(
                                plugin_name
                            )
                        )
...
# Backward compatibility alias (some modules may still import unified_plugin_manager)
