...
try:
    from plexichat.core.middleware.rate_limiting import RateLimitConfig, RateLimitAlgorithm  # type: ignore
except ImportError:
...
class RateLimitConfigManager:
    ...
    def get_effective_limits_for_user(self, user_tier: str = "guest") -> Dict[str, int]:
        ...
        return {
            "per_ip_requests_per_minute": int(self._config.per_ip_requests_per_minute * multiplier),
            "per_user_requests_per_minute": int(self._config.per_user_requests_per_minute * multiplier),
            "per_route_requests_per_minute": int(self._config.per_route_requests_per_minute * multiplier),
            "get_requests_per_minute": int(self._config.get_requests_per_minute * multiplier),
            "post_requests_per_minute": int(self._config.post_requests_per_minute * multiplier),
            "put_requests_per_minute": int(self._config.put_requests_per_minute * multiplier),
            "delete_requests_per_minute": int(self._config.delete_requests_per_minute * multiplier),
            "patch_requests_per_minute": int(self._config.patch_requests_per_minute * multiplier)
        }
