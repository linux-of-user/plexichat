...
from ..core.launcher import LaunchConfig, PlexiChatLauncher
...
class PlexiChatCLI:
    ...
    def _create_parser(self) -> argparse.ArgumentParser:
        ...
        setup_parser.add_argument(
            "--type", choices=["basic", "full"], default="basic", help="Setup type"
        )
        ...
        config_parser.add_argument(
            "action", choices=["show", "set", "get"], help="Config action"
        )
        ...
        try:
            ...
            if args.command in self.commands:
                ...
                return (
                    ...
                    if result
                    else f"Command '{args.command}' failed"
                )
            else:
    ...
    async def run_setup(self, args):
        """Run setup wizard."""
        logger.info(f" Running {args.type} setup...")
    ...
    async def restore_backup(self, args):
        """Restore from backup."""
        logger.info(f" Restoring from backup: {args.backup_name}")
    ...
    async def show_logs(self, args):
        """Show logs."""
        logger.info(f" Showing last {args.tail} log lines...")
